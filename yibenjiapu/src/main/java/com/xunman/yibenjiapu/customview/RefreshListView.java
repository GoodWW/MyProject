package com.xunman.yibenjiapu.customview;
...
public class RefreshListView extends ListView implements OnScrollListener{
	...
	private boolean isLoading; //正在加载的标记
	private  ILoadListtener iLoadListtener;
	private int state;
	...
	private void init(Context context) {
		...
		footView = (LinearLayout) inflater.inflate(R.layout.lv_foot, null);
...
//		arrowImageView.setMinimumHeight(50);
		...
		footView.findViewById(R.id.lv_foot_layout).setVisibility(View.GONE);
		//添加底部布局
	...
	public void onScroll(AbsListView arg0, int firstVisiableItem, int arg2,
		...
		lastVisibleItem = firstVisiableItem + arg2;
		totalItemCount = arg3;
	}
	...
	public void onScrollStateChanged(AbsListView arg0, int arg1) {
		if (totalItemCount == lastVisibleItem && arg1 == SCROLL_STATE_IDLE) {
			if (!isLoading) {
				isLoading = true;
				footView.findViewById(R.id.lv_foot_layout).setVisibility(View.VISIBLE);
				//加载更多数据
				iLoadListtener.onLoad();
			}
		}
	}

	public void loadConplete() {
		isLoading = false;
		footView.findViewById(R.id.lv_foot_layout).setVisibility(View.GONE);
	}

	public void setInterface(ILoadListtener iLoadListtener) {
		this.iLoadListtener = iLoadListtener;
	}

	//加载更多数据的回调接口
	public interface ILoadListtener {
		void onLoad();
	}
